...
- [ ] **P3 — Apply `escapeHtml()` in `_layouts/recipe.html`.**
...
- [ ] **P4.a — Escape all `innerHTML` sinks in `search-page.js`.**
...
- [ ] **P4.b — Debounce URL state and QR sync.**
...
- [ ] **P4.d — Tag-state URL-roundtrip safety.**
...
- [ ] **P5.a — Drop `search.html` + `search.json` + simple-jekyll-search.**
...
- [ ] **P6.b — `_includes/head.html` fixes.**
...
- [ ] **P6.e — Remove dead `#include-components` control.**
